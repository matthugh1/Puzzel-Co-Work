...
export function IconLoader({ size = 20, className }: IconProps) {
  return (
    <svg
      ...
      strokeLinejoin="round"
      className={className}
      style={{ animation: "cowork-spin 1s linear infinite" }}
    >
...
export function IconRefresh({ size = 20, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M20.49 15a9 9 0 11-2.12-9.36 9 9 0 011.12 3.36" />
      <polyline points="1 20 1 14 7 14" />
      <path d="M3.51 9a9 9 0 012.12 9.36 9 9 0 01-1.12-3.36" />
    </svg>
  );
}
...
export function IconThumbsUp({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconThumbsDown({ size = 20, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
