...
export function ToolResultBlock({ output, isError }: { output?: string; isError?: boolean }) {
  ...
  return (
    <div className={`cowork-message__tool-block cowork-message__tool-block--result ${isError ? "cowork-message__tool-block--error" : ""}`}>
      ...
      <div className="cowork-tool-card cowork-tool-card--compact">
        ...
        {preview && (
          <span className="cowork-tool-card__preview">
            {preview}
          </span>
        )}
      </button>
